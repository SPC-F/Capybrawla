...
PlayerController::PlayerController(const int max_health, const int start_health) : max_health_(max_health),
    health_{start_health}, lives_(3), emitter_validity_token_(std::shared_ptr<void>()){
}
