...
WeaponBoxingGlovesPlayerObject::WeaponBoxingGlovesPlayerObject(Scene& scene, GameObject& parent)
    : GameObject(scene) 
{
    ...
    const std::string attack_animation_name = "boxing_gloves_swing_anim";
    ...
    const Point sprite_offset_right{25.0f, 15.0f};
    const Point animator_offset_left{-30.0f, 15.0f};
    const Point animator_offset_right{25.0f, 15.0f};
