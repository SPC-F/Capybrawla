...
WeaponBatPlayerObject::WeaponBatPlayerObject(Scene& scene, GameObject& parent)
    : GameObject(scene) 
{
    ...
    const std::string attack_animation_name = "bat_swing_anim";
    ...
    const Point sprite_offset_right{15.0f, 0};
    const Point animator_offset_left{0.0f, 0};
